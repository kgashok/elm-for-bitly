			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							p: A2(author$project$Main$checkForMatches, s, model.p),
							P: s
						}),
					elm$core$Platform$Cmd$none);
			case 7:
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								I: elm$core$Maybe$Nothing,
								J: false,
								p: A2(author$project$Main$makeHayFromNames, model.P, nicknames)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								I: elm$core$Maybe$Nothing,
								J: false,
								p: A2(author$project$Main$makeHayFromUrls, model.P, urls)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var httpError = msg.a.a;
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('failed', model.J)
							]))
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
						A2(elm$core$Maybe$withDefault, 'status: Ok', model.I))
					])),
				A2(elm$html$Html$hr, _List_Nil, _List_Nil),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$placeholder(model.P),
